          ...
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4">
              <div className="mx-auto max-w-[550px] text-center">
                <span className="mb-2 block text-xl font-medium text-whit">
                  We Are Creative
                </span>
                <h1 className="mb-2 text-[60px] font-bold leading-tight text-whit md:text-[100px]">
                  Brand
                </h1>
                <h2 className="mb-6 text-[30px] font-semibold text-whit md:text-[40px]">
                  Fresh Car
                </h2>
                <p className="mx-auto mb-10 max-w-[460px] text-base font-medium text-[#C8CBCE">
               Our Product of old or new car collections is unique and fresh color cars.
                </p>
                <Link
             to ="/allProducts"
                  className="text-dark mb-2 inline-flex items-center justify-center rounded bg-white text-slate-500 font-bold py-3 px-6 text-center text-base  transition hover:bg-opacity-90"
                >
                  Discover More
                </Link>
              </div>
